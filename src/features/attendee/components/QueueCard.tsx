...
/**
 * QueueCard Component
 * Displays the current queue wait time and capacity details for a zone.
 * @param {QueueCardProps} props - The component props.
 * @returns {JSX.Element} The rendered QueueCard.
 */
export const QueueCard = memo(function QueueCard({ zone, className }: QueueCardProps): JSX.Element {
